...
export function ChannelsStep({ state, updateState }: ChannelsStepProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Telegram */}
      <div className={cn("rounded-xl border p-4 transition-colors", state.telegramEnabled ? "border-blue-500/50 bg-blue-500/5" : "border-gray-200 dark:border-white/10 bg-white dark:bg-white/[0.02]")}>
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className={cn(
              ...
              state.telegramEnabled ? "bg-blue-600" : "bg-gray-200 dark:bg-white/10"
            )}
          >
        ...
        {state.telegramEnabled && (
          <div className="space-y-2">
            <input
              ...
              className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-600 focus:outline-none focus:border-blue-500 transition-colors font-mono"
            />
      ...
      {/* Discord */}
      <div className={cn("rounded-xl border p-4 transition-colors", state.discordEnabled ? "border-blue-500/50 bg-blue-500/5" : "border-gray-200 dark:border-white/10 bg-white dark:bg-white/[0.02]")}>
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={cn(
              "w-10 h-5 rounded-full transition-colors relative",
              state.discordEnabled ? "bg-blue-600" : "bg-gray-200 dark:bg-white/10"
            )}
          >
      ...
      {/* Slack */}
      <div className={cn("rounded-xl border p-4 transition-colors", state.slackEnabled ? "border-blue-500/50 bg-blue-500/5" : "border-gray-200 dark:border-white/10 bg-white dark:bg-white/[0.02]")}>
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={cn(
              "w-10 h-5 rounded-full transition-colors relative",
              state.slackEnabled ? "bg-blue-600" : "bg-gray-200 dark:bg-white/10"
            )}
          >
