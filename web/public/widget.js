(function () {
  ...
  var BASE_URL = config.baseUrl || (typeof window !== 'undefined' && window.location.origin) || "https://synapseforge.ai";
  ...
  function createContainer() {
    ...
    if (!widgetConfig.hideBranding) {
      ...
      branding.innerHTML = 'Powered by <a href="https://synapseforge.ai" target="_blank" rel="noopener">SynapseForge</a>';
