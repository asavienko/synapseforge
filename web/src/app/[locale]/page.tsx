  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white grid-bg">
      ...
      <nav className="border-b border-white/5 backdrop-blur-md sticky top-0 z-50 bg-[#0a0a0f]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-4 sm:px-6 h-16 flex items-center justify-between">
      ...
      {/* ── Hero ─────────────────────────────────────────────────────────── */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 md:pt-24 pb-12 md:pb-16 text-center relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
          ...
          <Link
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 transition-all px-8 py-6 rounded-xl font-semibold text-lg shadow-lg shadow-violet-500/20"
          >
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <Link
              href="/templates"
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 border border-white/10 hover:border-white/20 hover:bg-white/[0.03] transition-colors px-4 sm:px-6 py-6 rounded-xl font-semibold text-base text-zinc-300 whitespace-nowrap"
            >
            ...
            <Link
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 border border-violet-500/30 hover:border-violet-500/60 bg-violet-500/5 hover:bg-violet-500/10 transition-colors px-4 sm:px-6 py-6 rounded-xl font-semibold text-base text-violet-300 hover:text-violet-200 whitespace-nowrap"
            >
      ...
      {/* ── Trust Signal Bar ─────────────────────────────────────────────── */}
      <section className="border-y border-white/5 bg-zinc-900/50 py-6 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-zinc-500">
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 to-violet-200 bg-clip-text text-transparent">12+</span>
              <span>{t("trust.businessesRunning")}</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/10" />
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 to-violet-200 bg-clip-text text-transparent">24/7</span>
              <span>{t("trust.alwaysOn")}</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/10" />
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 to-violet-200 bg-clip-text text-transparent">{"<3min"}</span>
              <span>{t("trust.setupTime")}</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/10" />
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 to-violet-200 bg-clip-text text-transparent">€0</span>
      ...
      <section id="how" className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="mt-14 max-w-2xl mx-auto">
          <div className="rounded-2xl border border-white/10 bg-black/60 overflow-hidden shadow-2xl">
            ...
            <div className="px-5 py-6 font-mono text-sm space-y-2">
              {[
        ...
        <div className="bg-zinc-900 border border-white/5 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 pb-8 border-b border-white/5">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-violet-400 mb-1">{t("caseStudy.metric1value")}</div>
              <div className="text-xs text-zinc-500">{t("caseStudy.metric1label")}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-emerald-400 mb-1">{t("caseStudy.metric2value")}</div>
              <div className="text-xs text-zinc-500">{t("caseStudy.metric2label")}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-amber-400 mb-1">{t("caseStudy.metric3value")}</div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          {[
            ...
            <details key={i} className="border-b border-white/5 py-6 group">
      ...
      <section id="about" className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
          <div>
            ...
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-500 transition-colors px-4 sm:px-6 py-3 rounded-xl font-semibold text-sm"
            >
      ...
      {/* ── CTA banner ───────────────────────────────────────────────────── */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 pb-20 sm:pb-12 mb-8">
        <div className="rounded-2xl border border-violet-500/20 bg-gradient-to-r from-violet-900/50 via-violet-800/30 to-indigo-900/50 p-12 text-center relative overflow-hidden shadow-2xl shadow-violet-500/10">
          ...
          <Link
            href="/sign-up"
            className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-500 transition-colors px-8 py-6 rounded-xl font-semibold text-lg relative"
          >
