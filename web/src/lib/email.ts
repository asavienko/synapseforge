...
export const email = {
  ...
  async sandboxColdStart(
    ...
    return send(
      to,
      `Your AI agent "${instanceName}" is ready to test`,
      base(
        `Your AI agent is ready to test, ${name.split(" ")[0]} 🤖`,
        `<p>You created <strong style="color:#e4e4e7">${instanceName}</strong> — great start!</p>
         <p>You have <strong style="color:#a78bfa">${sandboxLimit}</strong> free sandbox messages to test with.</p>
