...
export default function AdminFeedbackPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {feedback.length === 0 ? (
        <div className="p-12 text-center border border-gray-200 dark:border-white/5 rounded-xl bg-white dark:bg-white/[0.02]">
          <MessageSquare className="w-12 h-12 text-gray-400 dark:text-zinc-600 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No feedback yet</h3>
          <p className="text-gray-500 dark:text-zinc-500 text-sm max-w-md mx-auto">
          ...
          <div className="mt-4 p-3 bg-gray-50 dark:bg-white/5 rounded-lg text-xs text-gray-500 dark:text-zinc-500 font-mono">
        ...
        <div className="space-y-4">
          {feedback.map((item) => (
            <div
              key={item.id}
              className="p-4 border border-gray-200 dark:border-white/5 rounded-xl bg-white dark:bg-white/[0.02] hover:bg-white dark:bg-white/[0.04] transition-colors"
            >
