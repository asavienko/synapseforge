            ...
            <div className="glass-card glow-border rounded-2xl p-8 md:p-10 space-y-10">
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-500 dark:text-white/50 leading-relaxed">
                  ...
                  <p className="mt-3">
                    <strong className="text-gray-700 dark:text-white/70">API Key Security:</strong> You are solely responsible for securing any API keys, bot tokens, or credentials
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-500 dark:text-white/50 leading-relaxed">
                  <p><strong className="text-gray-700 dark:text-white/70">Payments:</strong> All payments are processed securely through Stripe. By subscribing to a paid plan, you authorize us to charge your payment method.</p>
                  <p><strong className="text-gray-700 dark:text-white/70">Billing Cycle:</strong> Subscriptions are billed monthly or annually in advance. You will be charged on the same date each billing period.</p>
                  <p><strong className="text-gray-700 dark:text-white/70">Cancellation:</strong> You may cancel your subscription at any time through your dashboard. Cancellation takes effect at the end of the current billing period.</p>
                  <p><strong className="text-gray-700 dark:text-white/70">Refunds:</strong> Refunds are handled on a case-by-case basis. Contact us within 14 days if you believe you are entitled to a refund.</p>
                  <p><strong className="text-gray-700 dark:text-white/70">Price Changes:</strong> We may update pricing with 30 days notice. Your continued use after changes constitutes acceptance.</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-500 dark:text-white/50 leading-relaxed">
                  <p>
                    <strong className="text-gray-700 dark:text-white/70">Your Content:</strong> You retain all rights to the data, prompts, and configurations you create.
                    You grant us a limited license to host and process this data solely to provide the service.
                  </p>
                  <p>
                    <strong className="text-gray-700 dark:text-white/70">Our Content:</strong> The OpenHelix AI platform, including code, designs, logos, and trademarks,
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-500 dark:text-white/50 leading-relaxed">
                  <p><strong className="text-gray-700 dark:text-white/70">By You:</strong> You may delete your account at any time. All data will be permanently removed within 30 days.</p>
                  <p><strong className="text-gray-700 dark:text-white/70">By Us:</strong> We may suspend or terminate your account for:</p>
                  <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-500 dark:text-white/50 leading-relaxed">
                  <p>
                    These Terms shall be governed by and construed in accordance with the laws of <strong className="text-gray-700 dark:text-white/70">Spain</strong>,
