...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-4 pt-16 sm:p-6 sm:pt-16 md:p-8 md:pt-6">
      ...
      {user.manager ? (
        <div className="glow-border rounded-2xl p-5 bg-white dark:bg-white/[0.02] mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
            <Link
              ...
              className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-zinc-400 hover:text-white bg-gray-50 dark:bg-white/5 hover:bg-gray-200 dark:bg-white/10 border border-gray-200 dark:border-white/10 px-4 py-2.5 rounded-xl transition-colors flex-1 sm:flex-none"
            >
