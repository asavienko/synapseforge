...
const typeColors = {
  feature: "text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 border-emerald-200 dark:border-emerald-500/20",
  improvement: "text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-500/20",
  fix: "text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20",
  security: "text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/20",
};
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <FadeInView direction="up">
            ...
            <p className="text-lg text-gray-500 dark:text-white/50 max-w-xl mx-auto">
              See what&apos;s new in OpenHelix AI
            </p>
          </FadeInView>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="space-y-12">
            {changelog.map((entry, index) => (
              <FadeInView key={entry.date} direction="up" delay={index * 100}>
                <div className="relative">
                  ...
                  {index < changelog.length - 1 && (
                    <div className="hidden sm:block absolute left-5 top-16 bottom-0 w-px bg-gray-200 dark:bg-white/10" />
                  )}
                </div>
              </FadeInView>
            ))}
