  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0f] text-gray-900 dark:text-[#f5f5f7]">
      ...
      <section className="relative overflow-hidden">
        {/* Ambient glow orbs */}
        <div className="glow-orb absolute -top-20 left-1/3 w-72 h-72 bg-blue-500/20 dark:bg-blue-500/10" />
        <div className="glow-orb absolute top-10 right-1/5 w-48 h-48 bg-violet-500/15 dark:bg-violet-500/8" style={{ animationDelay: "4s" }} />

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-10">
          <div className="max-w-4xl">
            ...
            <FadeInView direction="up" delay={100}>
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 rounded-2xl glass-card flex items-center justify-center shrink-0 !p-0 border-blue-200/50 dark:border-blue-500/15 bg-blue-50/80 dark:bg-blue-500/10">
            ...
            <FadeInView direction="up" delay={150}>
              <div className="flex flex-wrap gap-1.5 mb-8">
                {template.tags.map((tag) => (
                  <span
                    key={tag}
                    className="glass-badge text-[11px] py-1 px-2.5 text-gray-500 dark:text-white/45"
                  >
                    #{tag}
                  </span>
                ))}
            ...
            <FadeInView direction="up" delay={200}>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="glass-btn-primary inline-flex items-center justify-center gap-2 text-white px-7 py-3.5 font-semibold text-[15px]"
                >
                ...
                {!isLoggedIn && (
                  <Link
                    href="/contact"
                    className="glass-btn-secondary inline-flex items-center justify-center gap-2 px-5 py-3.5 font-medium text-[14px] text-gray-600 dark:text-white/60"
                  >
                    Talk to Sales
      ...
      {/* ── Main Content ───────────────────────────────────────────────── */}
      <section className="relative bg-gray-50/60 dark:bg-white/[0.015] py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <FadeInView direction="up" delay={100}>
                <div className="glass-card p-6 sm:p-8">
                  <h2 className="text-[16px] font-semibold mb-5 flex items-center gap-2">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {template.useCases.map((useCase, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-3 p-3.5 rounded-xl glass-surface"
                      >
                        <div className="w-5 h-5 rounded-full bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/15 flex items-center justify-center shrink-0 mt-0.5">
              ...
              <FadeInView direction="up" delay={200}>
                <div className="glass-card p-6 sm:p-8">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="glass-badge text-[11px] py-0.5 px-2 text-gray-400 dark:text-white/30">
                  ...
                  <div className="relative">
                    <div className="rounded-xl border border-gray-200/60 dark:border-white/[0.06] overflow-hidden">
                      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-100 dark:border-white/[0.06] bg-gray-50/80 dark:bg-white/[0.02]">
                ...
                <div className="glass-card p-6 sm:p-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {template.suggestedChannels.map((channel) => (
                      <span
                        key={channel}
                        className="glass-badge text-[12px] py-1.5 px-3 text-gray-500 dark:text-white/45 hover:border-blue-300 dark:hover:border-blue-500/30 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-default"
                      >
              ...
              <FadeInView direction="up" delay={400}>
                <div className="glass-card p-6 sm:p-8">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl glass-surface">
            ...
            <div className="space-y-5">
              ...
              <FadeInView direction="up" delay={100}>
                <div className="glass-card glow-border p-5">
                  ...
                  <Link
                    ...
                    className="glass-btn-primary block w-full text-center text-white px-5 py-3 font-semibold text-[14px]"
                  >
                    Deploy Now
                  </Link>
                  {!isLoggedIn && (
              ...
              <FadeInView direction="up" delay={200}>
                <div className="glass-card p-5">
                  ...
                  <div className="space-y-3 text-[13px]">
                    {[
                      { label: "Difficulty", value: template.difficulty, badge: true },
                      { label: "Category", value: template.category, badge: false },
                      { label: "Model", value: template.suggestedModel, badge: false },
                      { label: "Tags", value: String(template.tags.length), badge: false },
                    ].map((stat) => (
                      <div key={stat.label} className="flex justify-between items-center">
                        <span className="text-gray-400 dark:text-white/35">{stat.label}</span>
                        {stat.badge ? (
                          <span className={`text-[11px] px-2 py-0.5 rounded-full font-medium border ${difficultyColors[template.difficulty]}`}>
                            {stat.value}
                          </span>
                        ) : (
                    ...
                    <div className="space-y-2.5">
                      {relatedTemplates.map((related) => (
                        <Link
                          ...
                          className="flex items-center gap-3 p-3 rounded-xl glass-surface hover:border-blue-200 dark:hover:border-blue-500/20 transition-all group"
                        >
                          ...
                          <ArrowRight className="w-3.5 h-3.5 text-gray-300 dark:text-white/20 group-hover:text-blue-400 transition-colors" />
                        </Link>
                      ))}
                    </div>
                  </div>
              ...
              <FadeInView direction="up" delay={400}>
                <div className="glass-card p-5">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-1.5 text-[13px] text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors"
                  >
                    Contact Support
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20">
        <FadeInView direction="up">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
            ...
            <Link
              href="/templates"
              className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 font-medium text-[13px] transition-all hover:gap-3 shrink-0"
            >
