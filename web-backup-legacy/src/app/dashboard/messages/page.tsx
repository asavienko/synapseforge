  ...
  if (noManager) {
    return (
      <div className="p-8">
        ...
        <p className="text-zinc-400 text-sm mb-8">Chat with your dedicated manager.</p>
        <div className="glow-border rounded-2xl p-12 bg-white/[0.02] text-center max-w-lg">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Manager not assigned yet</h3>
          <p className="text-zinc-400 text-sm leading-relaxed">
            A dedicated manager will be assigned to your account shortly.
            Once assigned, you can message them directly here.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col h-screen md:h-[calc(100vh)] pt-0">
      ...
      <div className="p-6 border-b border-white/5 shrink-0">
        ...
        <p className="text-zinc-400 text-sm mt-1">Chat with your dedicated manager.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-zinc-500 text-sm">No messages yet. Say hi to your manager!</p>
          </div>
        ) : (
          messages.map((msg) => {
